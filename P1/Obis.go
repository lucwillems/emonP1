...
var (
	TypeInfo = map[string]OType{
		...
		OBISTypePowerDelivered:                {Float, "W", "Actual Power delivered", "Pd"},
		OBISTypePowerGenerated:                {Float, "W", "Actual Power generated", "Pg"},
